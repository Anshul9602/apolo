...
<body class="text-white">
    ...
    <div class="d-flex justify-content-center align-items-center position-relative heroSectionHeight" style="margin-top: 70px;">
        <div class="position-relative w-100" style="height:100%; overflow:hidden;">
            ...
            <div class="text-center position-relative d-flex flex-column justify-content-center align-items-center" style="height:100%; z-index:2;">
                <h1 class="fw-bold display-3 text-white">Premium Leather Jackets,<br> Built for Your Brand</h1>
    ...
    <div class="container py-5" style="background:#fff;">
        <div class="row align-items-center g-5 m-0      ">
            ...
            <div class="col-lg-6 col-md-12">
                <img src="assets/j1.png" alt="Random Image" class="w-100" style="border-radius:15px; box-shadow:0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s;">
            </div>
