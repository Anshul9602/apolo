    ...
    <div class="d-flex justify-content-center align-items-center position-relative heroSectionHeight">
        <div class="position-relative w-100" style="height:100%; overflow:hidden;">
            <video autoplay muted loop playsinline class="position-absolute top-0 start-0 w-100 h-100" style="object-fit:cover; object-position:center; z-index:0;">
                <source src="<?php echo base_url('assets/Shoes.mp4') ?>" type="video/mp4">
    ...
    <div class="container py-5" style="background:#fff;">
        <div class="row align-items-center g-5 m-0">
            ...
            <div class="col-lg-6 col-md-12">
                <img src="assets/s1.jpeg" alt="Random Image" class="w-100" style="border-radius:15px; box-shadow:0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s;">
            </div>
