...
<div class="d-flex justify-content-center align-items-center position-relative heroSectionHeight" 
  ...
  <!-- Background image -->
  <img src="https://img.freepik.com/free-photo/close-up-shoemaker-using-sewing-machine_171337-12305.jpg?t=st=1758955491~exp=1758959091~hmac=1aaa56dc0e8a14d41f6dc07221ba15d7dc84c52ceab7b739f7a118acc813aab8&w=2000" 
...
<div class="d-flex justify-content-center align-items-center text-center bg-light" 
     style="height:auto; padding:4rem 2rem;">
...
<div class="d-flex flex-column justify-content-center align-items-center text-center" 
     style="height:50vh; background:#fff; padding:2rem;">
  
  <!-- Heading -->
  <h2 class="fw-bold mb-1 pb-5" style="color:#002D60; font-size:2.5rem;">
  ...
  <div class="container">
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-6 col-md-3">
        <h3 class="fw-bold counter" data-target="850000" 
            style="color:#000000; font-size:2rem;">0</h3>
        <p class="text-dark">Footwear (pairs)</p>
      </div>

      <!-- Outerwear -->
      <div class="col-6 col-md-3">
        <h3 class="fw-bold counter" data-target="400000" 
            style="color:#000000; font-size:2rem;">0</h3>
      ...
      <!-- Bags -->
      <div class="col-6 col-md-3">
        <h3 class="fw-bold counter" data-target="300000" 
            style="color:#000000; font-size:2rem;">0</h3>
      ...
      <!-- Belts & SLGs -->
      <div class="col-6 col-md-3">
        <h3 class="fw-bold counter" data-target="700000" 
            style="color:#000000; font-size:2rem;">0</h3>
...
<div class="d-flex flex-column justify-content-center align-items-center" 
     style="min-height:100vh; background:#f9f9f9; padding:3rem 1rem;">
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-12 col-md-4">
        <div class="card h-100 shadow-lg border-0" style="border-radius:20px; overflow:hidden;">
          <img src="https://img.freepik.com/free-photo/hands-partners_53876-94667.jpg" 
               class="card-img-top" 
               alt="Your Partner in Growth" 
      ...
      <div class="col-12 col-md-4">
        <div class="card h-100 shadow-lg border-0" style="border-radius:20px; overflow:hidden;">
          <img src="https://img.freepik.com/free-photo/man-studio-creates-leather-ware_53876-20840.jpg"    class="card-img-top" 
      ...
      <div class="col-12 col-md-4">
        <div class="card h-100 shadow-lg border-0" style="border-radius:20px; overflow:hidden;">
          <img src="https://img.freepik.com/free-photo/man-studio-creates-leather-ware_53876-20840.jpg" 
               class="card-img-top" 
               alt="Designed for Tomorrow" 
               style="height:250px; object-fit:cover;">
          <div class="card-body text-center p-4">
